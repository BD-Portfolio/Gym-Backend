...
obj.generateJWT = async (id, first_name, last_name, email, phone, bio) => {
    return jwt.sign({id : id, first_name : first_name, last_name : last_name, email : email, phone : phone, bio : bio }, 'secretkey');
}
